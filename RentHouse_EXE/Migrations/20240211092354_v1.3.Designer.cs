            ...
            modelBuilder.Entity("RentHouse_EXE.Model.Payment", b =>
                {
                    ...
                    b.Property<Guid?>("PriceDecreaseId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PriceDecreases")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PriceDescreases");
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.Payment", b =>
                {
                    ...
                    b.HasOne("RentHouse_EXE.Model.PriceDecreases", "PriceDecrease")
                        .WithMany("Payments")
                        .HasForeignKey("PriceDecreaseId");
