...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PostRealEstate", b =>
                {
                    ...
                    b.Property<Guid>("PriceUnit")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PriceUnit");

                    b.Property<Guid>("PriceUnitsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PriceUnitsId");

                    b.HasIndex("StatusId");

                    b.HasIndex("TypeRealEstateId");

                    b.ToTable("PostRealEstates");
                });

            modelBuilder.Entity("RentHouse_EXE.Model.PriceDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PriceDecreases", b =>
                {
                    ...
                    b.Property<Guid>("PriceDayId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PriceDayId");
                    ...
                    b.HasIndex("PriceDayId");

                    b.ToTable("PriceDecreases");
                });

            modelBuilder.Entity("RentHouse_EXE.Model.PricePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.Payment", b =>
                {
                    b.HasOne("RentHouse_EXE.Model.Plan", "Plan")
                        .WithMany("Payments")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentHouse_EXE.Model.Status", "StatusPayment")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PostRealEstate", b =>
                {
                    ...
                    b.HasOne("RentHouse_EXE.Model.Payment", "Payments")
                        .WithMany("PostRealEstates")
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PriceDecreases", b =>
                {
                    b.HasOne("RentHouse_EXE.Model.PriceDay", "PriceDays")
                        .WithMany("PriceDecreases")
                        .HasForeignKey("PriceDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PriceDays");
                });
