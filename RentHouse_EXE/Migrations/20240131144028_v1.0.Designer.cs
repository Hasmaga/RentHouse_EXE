...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PlanPrice", b =>
                {
                    ...
                    b.Property<Guid>("PriceDescreaseId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PriceDescreaseId");

                    b.Property<decimal>("TagPrice")
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PostRealEstate", b =>
                {
                    ...
                    b.Property<DateTime>("DateUpPost")
                        .HasColumnType("datetime2")
                        .HasColumnName("DateUpPost");
                    ...
                    b.Property<int>("RealEstateCode")
                        .HasColumnType("int")
                        .HasColumnName("RealEstateCode");
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PriceDescrease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<decimal>("PrecentageDescrease")
                        .HasColumnType("decimal(18,10)")
                        .HasColumnName("PrecentageDescrease");
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PlanPrice", b =>
                {
                    b.HasOne("RentHouse_EXE.Model.PriceDescrease", "PriceDescreases")
                        .WithMany("PlanPrices")
                        .HasForeignKey("PriceDescreaseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("PriceDescreases");
                });
            ...
            modelBuilder.Entity("RentHouse_EXE.Model.PostRealEstate", b =>
                {
                    ...
                    b.HasOne("RentHouse_EXE.Model.PlanPrice", "PlanPrices")
